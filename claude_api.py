...
# ------------------- CONFIGURATION -------------------
OUTPUT_FILE = 'data/raw_citations_claude.csv'
...
def main():
    ...
    print(f"Starting citation generation with Claude {MODEL_NAME}")
    ...
    for i, task in enumerate(ALL_TASKS[start_index:], start_index + 1):
        ...
        if citation_text:
            ...
            filename = f"claude_{country.replace(' ', '_')}_{prompt_type.lower()}.txt"
